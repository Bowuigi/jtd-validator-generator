...
testCase('enum rejects "UNKNOWN"', STATUS_SCHEMA, 'UNKNOWN', [{
  path: [],
...
testCase('enum with nullable: true still rejects "UNKNOWN"', NULLABLE_ENUM_SCHEMA, 'UNKNOWN', [{
  path: [],
  message: 'unexpected "UNKNOWN"',
  suggestions: STATUSES
}]);
...
testCase('single-value enum rejects "OTHER"', { enum: ['ONLY'] }, 'OTHER', [{
  path: [],
  message: 'unexpected "OTHER"',
  suggestions: ['ONLY']
}]);
